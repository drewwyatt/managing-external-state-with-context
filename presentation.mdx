...
<CodeSurfer
  title="You can dispatch actions"
  code={require("raw-loader!./snippets/jwplayer/actions.snippet")}
/>

---

### What (I assume) goes through most people's heads when this happens
...
<ul style={{ textAlign: 'left' }}>
  ...
  <li>I did my best to replicate the problem with a clock</li>
</ul>
